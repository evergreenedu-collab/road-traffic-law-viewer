...
매주 월요일 새벽 02:00 KST에 `update_all.py`가 GitHub 서버에서 자동 실행되어 데이터를 갱신하고 사이트에 배포합니다 (`.github/workflows/update.yml`). 사용자 PC와 무관하게 GitHub이 자기 서버에서 실행하므로 별도 조작이 필요 없습니다.
