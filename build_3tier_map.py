...
LAW_GROUPS = {
    ...
    "tlspc": {
        ...
        "시행령": {"법령명": "교통사고처리 특례법 시행령", "MST": "227259", "약칭": "영"},
    },
    # Phase 3 S3-1-b-4-d (2026-05-22): 단일 법률 그룹 — 시행령·시행규칙 없음
    "tkga": {
        "법률": {"법령명": "특정범죄 가중처벌 등에 관한 법률", "MST": "270397", "약칭": "법"},
    },
    "crim_proc": {
        "법률": {"법령명": "형사소송법", "MST": "281865", "약칭": "법"},
    },
    # Phase 3 (2026-05-22): 3단 구조 — 자동차관리법·여객·화물
    "car_mgmt": {
        "법률":     {"법령명": "자동차관리법",         "MST": "283767", "약칭": "법"},
        "시행령":   {"법령명": "자동차관리법 시행령",   "MST": "277973", "약칭": "영"},
        "시행규칙": {"법령명": "자동차관리법 시행규칙", "MST": "285101", "약칭": "규칙"},
    },
    "passenger_transport": {
        "법률":     {"법령명": "여객자동차 운수사업법",         "MST": "284089", "약칭": "법"},
        "시행령":   {"법령명": "여객자동차 운수사업법 시행령",   "MST": "285857", "약칭": "영"},
        "시행규칙": {"법령명": "여객자동차 운수사업법 시행규칙", "MST": "285433", "약칭": "규칙"},
    },
    "cargo_transport": {
        "법률":     {"법령명": "화물자동차 운수사업법",         "MST": "284427", "약칭": "법"},
        "시행령":   {"법령명": "화물자동차 운수사업법 시행령",   "MST": "279281", "약칭": "영"},
        "시행규칙": {"법령명": "화물자동차 운수사업법 시행규칙", "MST": "282123", "약칭": "규칙"},
    },
}
