...
LAW_GROUPS = {
    "road": {
        ...
        "시행령":   {"법령명": "도로교통법 시행령",   "MST": "269989", "법령ID": "003395", "약칭": "영"},
        "시행규칙": {"법령명": "도로교통법 시행규칙", "MST": "285317", "법령ID": "007079", "약칭": "규칙"},
    },
    # Phase 3 S3-1-b-2: 교통사고처리 특례법 (법률 + 시행령). 시행규칙 없음.
    "tlspc": {
        "법률":   {"법령명": "교통사고처리 특례법",       "MST": "268077", "법령ID": "001131", "약칭": "법"},
        "시행령": {"법령명": "교통사고처리 특례법 시행령", "MST": "227259", "법령ID": "002616", "약칭": "영"},
    },
    # 2026-05-25 보정: 사용자 검증으로 단일법 가정 오류 발견 — 실제로는 부속 규범 존재
    # tkga: 시행령 존재 (별표는 0개지만 본문은 의미 있음)
    # crim_proc: 시행령 없음, 대신 형사소송규칙(대법원규칙) 존재 — 시행규칙 슬롯에 등록
    "tkga": {
        "법률":   {"법령명": "특정범죄 가중처벌 등에 관한 법률",       "MST": "270397", "법령ID": "001676", "약칭": "법"},
        "시행령": {"법령명": "특정범죄 가중처벌 등에 관한 법률 시행령", "MST": "235005", "법령ID": "005326", "약칭": "영"},
    },
    "crim_proc": {
        "법률":     {"법령명": "형사소송법",   "MST": "281865", "법령ID": "001671", "약칭": "법"},
        "시행규칙": {"법령명": "형사소송규칙", "MST": "273605", "법령ID": "005988", "약칭": "규칙",
                    "_주석": "대법원규칙 — 일반 시행규칙과 입법자 다름(대법원). viewer 구조상 '시행규칙' 슬롯에 등록"},
    },
    # Phase 3 (2026-05-22): 3단 구조 — 자동차관리법·여객·화물
    "car_mgmt": {
        "법률":     {"법령명": "자동차관리법",         "MST": "283767", "법령ID": "001747", "약칭": "법"},
        "시행령":   {"법령명": "자동차관리법 시행령",   "MST": "277973", "법령ID": "004590", "약칭": "영"},
        "시행규칙": {"법령명": "자동차관리법 시행규칙", "MST": "285101", "법령ID": "007928", "약칭": "규칙"},
    },
    "passenger_transport": {
        "법률":     {"법령명": "여객자동차 운수사업법",         "MST": "284089", "법령ID": "001749", "약칭": "법"},
        "시행령":   {"법령명": "여객자동차 운수사업법 시행령",   "MST": "285857", "법령ID": "004175", "약칭": "영"},
        "시행규칙": {"법령명": "여객자동차 운수사업법 시행규칙", "MST": "285433", "법령ID": "007709", "약칭": "규칙"},
    },
    "cargo_transport": {
        "법률":     {"법령명": "화물자동차 운수사업법",         "MST": "284427", "법령ID": "001748", "약칭": "법"},
        "시행령":   {"법령명": "화물자동차 운수사업법 시행령",   "MST": "279281", "법령ID": "005667", "약칭": "영"},
        "시행규칙": {"법령명": "화물자동차 운수사업법 시행규칙", "MST": "282123", "법령ID": "008740", "약칭": "규칙"},
    },
}
