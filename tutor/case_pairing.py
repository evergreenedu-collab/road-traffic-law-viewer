...
ARTICLE_TOPIC_KEYWORDS = {
    ...
    '88': ['정기적성검사', '적성검사'],
    '89': ['수시 적성검사', '수시적성검사'],
    # PR-H5-κ: 옛 조문번호 인용 함정 차단 — 150조는 공동위험행위·교육·자격증·학원 부정 중심.
    # 옛 도교법 150조 제2호가 음주측정거부였으나 현재는 다른 조문으로 이동.
    # 음주측정거부 키워드만 있는 판례는 본 키워드 미일치로 150 매핑 풀에서 제외됨.
    '150': ['공동위험행위', '공동 위험행위', '면허증 대여', '강사자격증', '학원 등록', '전문학원', '운전교육'],
    '149': ['교통질서', '안전운전 의무'],
    '156': ['일반 위반', '범칙'],
}
