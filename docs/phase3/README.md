...
- ✅ 완료 (12개): **F1·F2·F3·F4·F5·F6 + S1-A·S2-A·S4(staging)·S6·S7 + S3-1-b-4-a**
- 🟡 부분 완료: **S3-1-a/b·S3-1-b-4-a** (외부 링크·title·h1 동적, tlspc 비활성 상태 유지)
- 🔴 다음 세션 진입점: **S3-1-b-4-b** (viewer 드롭다운 UX 재설계, 40분) + **S3-1-b-4-c** (연혁 안내, 10분)
